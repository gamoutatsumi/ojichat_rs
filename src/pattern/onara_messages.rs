...
pub mod onara_messages {
    pub fn select_template(emotion: super::OjisanEmotion) -> &'static str {
        use rand::prelude::*;
        let mut messages: Vec<&str> = Vec::with_capacity(20);
        match emotion {
            super::OjisanEmotion::GREETING => {
                messages = vec![
            ...
            super::OjisanEmotion::INVITATION => {
                messages = vec![
            ...
            super::OjisanEmotion::ADMIRATION => {
                messages = vec![
